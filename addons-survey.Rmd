...
This survey was inspired by the chart below, which shows (for all **add-on users**) the distribution of the number of days elapsed before the first add-on installation event. Original re:dash query is [here](https://sql.telemetry.mozilla.org/queries/51128/source#137165). 
